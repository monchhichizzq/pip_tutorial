...
class FaceRecognitionExample(object):
    def __init__(self, img_1, img_2, img_3):
        ...
        self.img_size = 150
        self.predictor = dlib.shape_predictor(r'../nets/shape_predictor_68_face_landmarks.dat')
        self.recognition = dlib.face_recognition_model_v1('../nets/dlib_face_recognition_resnet_model_v1.dat')
...
if __name__=="__main__":
    ...
    # 初始化关键点检测模型
    predictor = dlib.shape_predictor(r'nets/shape_predictor_68_face_landmarks.dat')
    # 初始化人脸特征模型
    recognition = dlib.face_recognition_model_v1('nets/dlib_face_recognition_resnet_model_v1.dat')
    # 明明老师的人脸特征
    ...
    while 1:
        ...
        for det in dets:
            ...
            #pdb.set_trace()
            # 人脸对齐
            face_align=dlib.get_face_chip(frame, shape, 150, 0.1) # 瞳孔间距0.1 数据集与真实不同设定
            # 活体检测 动作活体比较成熟
            is_attack_str = 'live'
